...
<body>
                    ...
                    <div class="container">
                        ...
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                            ...
                            <div class="form-group row">
                                <!-- Name -->
                                <label class="col-md-4 col-form-label" for="name">Name:<span class="err"> *</span></label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <!-- Password -->
                                <label class="col-md-4" for="pwd">Password:<span class="err"> *</span></label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-md-4" for="number">Number:<span class="err"> *</span></label>
                                <div class="col-md-8">
    ...
    <?php
            ...
            VALUES (NULL, '$name', '$pwd', '$number', '$backupNum', '$address', '$blockNo', '$doorNo', '$entryDate', '$status', '1')";
