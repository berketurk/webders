...
<br><br><br>
<h10 class="mx-auto my-0 text-uppercase text-center">Add Debt</h10>
</div>
...
<form method="post" action="">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter The Resident Name And Surname">
                                </div>
                            </div>
                            <div class="form-group d-flex">
                                <label class="col-md-2 col-sm-3 col-xs-12" style="color: white">Month</label>
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" name="month" id="month" placeholder="Enter The Month The Resident Paid">
                                </div>
                            </div>
                            <div class="form-group d-flex">
                                <label class="col-md-2 col-sm-3 col-xs-12" style="color: white">Amount</label>
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" name="amount" id="amount" placeholder="Enter Amount to Pay Resident">
                                </div>
                            </div>
