...
<body>
    ...
    <div class="container col-md-4 my-3 bg-dark text-white">
    ...
    <h2 class="text-center mb-4">Expense</h2>
        ...
        <form class="form" method="POST" action="expense.php">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control" name="expenseDetail" id="expenseDetail" cols="30" rows="2"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <input class="btn btn-primary btn-block" type="submit" name="dueSubmit" id="dueSubmit" onclick="return confirm('Apartman için masraf giriyorsun, Onaylıyor musun?')">
                </div>
