            ...
            <div class="col-md-12 mb-12">
                <div class="card h-10">
                    ...
                    <div class="card-body2">
                        <h4 class="card-title">
                            <a href="itemdesc.html">Borcu Olan Listesi</a> <br><br><br>
                        </h4>
                        
                        <?php

$bul = "SELECT * FROM borç" ;
...
if ($kayit->num_rows>0) {
    ...
    while ($satir = $kayit->fetch_assoc()) {
        ...
        echo "<h5> <b> *Daire No: ".$satir["door"]."'de oturan " .$satir["name"]. ", " .$satir["month"]. " Ayı için " .$satir["amount"]. "TL Aidat ödemesi yapmamıştır, en kısa sürede yapmasını rica ederiz. <br> <br>" ;
    }
