            ...
            <div class="col-md-12 mb-12">
                <div class="card h-10">
                    ...
                    <div class="card-body2">
                        <h4 class="card-title">
                            <a href="itemdesc.html">Apartman Sakinleri</a> <br><br><br>
                        </h4>
                        
                        <?php

$bul = "SELECT * FROM residents " ;
...
echo "</tr>";
    ...
    while ($satir = $kayit->fetch_assoc()) {
        ...
        echo '<tr>' ;
        echo '<td> <hr> *' .$satir['name']. '</td>';
        echo '<td> <hr> ' .$satir['door']. '</td>';
        echo '<td> <hr> ' .$satir['phone1']. '</td>';
        echo '<td> <hr> ' .$satir['email']. '</td>';
        echo '</tr>' ;
    }
