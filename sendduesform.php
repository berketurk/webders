    ...
    <h2 class="text-center mb-4">Send Due</h2>
        ...
        ?>
            ...
            <form class="form" method="POST" action="senddues.php">
                ...
                <div class="row">
                    <input class="btn btn-primary btn-block" type="submit" name="dueSubmit" id="dueSubmit" onclick="return confirm('Apartman Sakinlerine Aidat göndermesi yapıyorsun. Onaylıyor musun?')">
                </div>
            </form>
    </div>
